...
<body onload="checkType('accountType','home', '') ? checkType('type', 'IDPage', localStorage.getItem('accountType')) : ''">
    ...
    <div class="row">
        <div class="col-3">
            ...
            <ul class="nav nav-pills" role="tablist" id="accountTypeNav">
                <div class="container">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="pill" href="#homePage" id="homeTab">Home</a>
                    </li>
                </div>
                <div class="container">
                    <li class="nav-item">
        ...
        <div class="col-9">
            <div class="tab-content">
                <div id="homePage" class="container tab-pane active"><br>
                    <h3>欢迎来到核算填报网站</h3>
                    <p>请根据您的身份选择登录界面</p>
                </div>
                    ...
                    <div class="container">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item active">
                                <a class="nav-link active" data-bs-toggle="tab" href="#teacherIDPage" id="teacherIDTab">
                                    使用ID登录
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="container mt-3">
                                    ...
                                    <form action="" id="teacherIdSubmit">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                                onclick="isRemember('remember') ? saveForever(getValue('Id'),'id',getValue('pswd'), 'teacher') : ''">
                                            Submit
                                        </button>
                                    </form>
                                </div>
                            ...
                            <div id="teacherEmailPage" class="container tab-pane fade"><br>
                                <div class="container mt-3">
                                    ...
                                    <form action="" id="teacherEmailSubmit">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                                onclick="isRemember('remember') ? saveForever(getValue('email'),'email',getValue('pswd'), 'teacher') : ''">
                                            Submit
                                        </button>
                                    </form>
                                </div>
                            ...
                            <div id="teacherPhonePage" class="container tab-pane fade"><br>
                                <div class="container mt-3">
                                    ...
                                    <form action="">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                                onclick="isRemember('remember') ? saveForever(getValue('phone'),'phone',getValue('pswd'), 'teacher') : ''">
                                            Submit
                                        </button>
                                    </form>
                                </div>
                                ...
                                <div class="container mt-3">
                                    ...
                                    <form action="">
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="managerPhone"
                                                   placeholder="Enter phone"
                                                   name="phone">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="container mt-3">
                                    ...
                                    <form action="">
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="liaisonPhone"
                                                   placeholder="Enter phone"
                                                   name="phone">
                                        </div>
                                        <div class="mb-3">
...
<script>
    ...
    function login(){
        ...
        if(accountType == ""){
            ...
            var path = getSubmit(localStorage.getItem("type"),accountType);
            const submit = document.getElementById(path).elements;
            submit[0] =
            var len = submit.
        }
    }
    ...
    function isRemember(name) {
        var s = getChkBoxValue(name);
        //那么现在来检测s的值就知道选中的复选框的值了
        //alert(s);
        return s != "";
    }

    function getChkBoxValue(name) {
