                ...
                <table class="table table-hover table-light">
                    ...
                    <%
                        ...
                        while(rs.next()){
                            ...
                            String ret2 = rs.getString("phone");
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <button type="button" class="btn btn-primary">
                                    <a href="editLiaison.jsp?id=<%=ret%>&ins=<%=ret1%>&pn=<%=ret2%>&em=<%=ret3%>&pw=<%=ret4%>" style="color:white;text-decoration: none " )>编辑</a>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    <a href="deleteLiaison.jsp?id=<%=ret%>" style="color:white;text-decoration: none " onClick="return confirm('确认删除当前记录?')">删除</a>
                                </button>
                            </div>
                        </td>
                    </tr>
