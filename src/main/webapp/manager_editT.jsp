...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <h3 class="text-left"><mark>修改教师账号</mark></h3>
            <%
                String s1 = request.getParameter("id");
                String s2 = request.getParameter("name");
                String s3 = request.getParameter("gender");
                String s4 = request.getParameter("age");
                String s5 = request.getParameter("institute");
                String s6 = request.getParameter("pn");
                String s7 = request.getParameter("email");
                String s8 = request.getParameter("pw");
            %>
            <div class="row g-2">
                <div class="col-6">
                    <div id ="abcd" class="input-group">
                        <span class="input-group-text">
                            ID
                        </span>
                        <input id="teaid" type="text" class="form-control" value="<%=s1%>" readonly="readonly">
                    </div>
                </div>
                <div class="col-6">
                    <div class="input-group">
                        ...
                        <input id="name" type="text" class="form-control" value="<%=s2%>">
                    </div>
                </div>
                <div class="col-6">
                    <div class="input-group">
                        ...
                        <input id="gender" type="text" class="form-control" value="<%=s3%>">
                    </div>
                </div>
                <div class="col-6">
                    <div class="input-group">
                        ...
                        <input id="age" type="text" class="form-control" value="<%=s4%>">
                    </div>
                </div>
                <div class="col-12">
                    <div class="input-group">
                        ...
                        <input id="ph" type="text" class="form-control" value="<%=s6%>">
                    </div>
                </div>
                <div class="col-12">
                    <div class="input-group">
                        ...
                        <input id="em" type="text" class="form-control" value="<%=s7%>">
                    </div>
                </div>
                <div class="col-12">
                    <div class="input-group">
                        ...
                        <input id="pw" type="text" class="form-control" value="<%=s8%>">
                    </div>
                </div>
                <div class="col-12">
                    <div class="input-group">
                        ...
                        <input id="ins" type="text" class="form-control" list="typelist" placeholder="请选择所属学院">
                ...
                <%--隐式表单储存数据上传--%>
                <form name = "frmApp" action = "manager_editbackT.jsp" id= "frmAppId" mothed= "post" />
                <input id= "a" type= "hidden" name = "id" >
                <input id= "b" type= "hidden" name = "name" >
                <input id= "c" type= "hidden" name = "gender" >
                <input id= "d" type= "hidden" name = "age" >
                <input id= "e" type= "hidden" name = "pn" >
                <input id= "f" type= "hidden" name = "em" >
                <input id= "g" type= "hidden" name = "pw" >
                <input id= "h" type= "hidden" name = "ins" >
                </form>
                <script>
                    function setItemValue(){
                        ...
                        let institute = document.getElementById("ins").value;
                        document.getElementById( "a" ).value = id;  // 将JS变量值存储到隐藏控件中
                        document.getElementById( "b" ).value = name;  // 将JS变量值存储到隐藏控件中
                        document.getElementById( "c" ).value = gender;  // 将JS变量值存储到隐藏控件中
                        document.getElementById( "d" ).value = age;  // 将JS变量值存储到隐藏控件中
                        document.getElementById( "e" ).value = phonenumber;  // 将JS变量值存储到隐藏控件中
                        document.getElementById( "f" ).value = email;  // 将JS变量值存储到隐藏控件中
                        document.getElementById( "g" ).value = password;  // 将JS变量值存储到隐藏控件中
                        document.getElementById( "h" ).value = institute;  // 将JS变量值存储到隐藏控件中
                    }
                    function submit(){
